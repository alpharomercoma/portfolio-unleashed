...
const awards: Award[] = [
    {
        title: "Philippine Junior Data Science Challenge Finalist & GlobalCo Special Awards",
...
function HonorsAndAwards() {
    ...
    const currentAwards = filteredAwards.slice(currentPage * itemsPerPage, (currentPage + 1) * itemsPerPage);

    return (
        <section className="py-12" id="awards">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold mb-10 text-center">Honors and Awards</h2>
                <Tabs value={activeTab} onValueChange={(value) => { setActiveTab(value as 'technical' | 'language'); setCurrentPage(0); }}>
            ...
            {awards.map((award, index) => (
                <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl">
                    ...
                    <div className="p-4">
                        ...
                        <p className="text-sm text-gray-600 mb-1">Issued by: {award.issuedBy}</p>
