...
const projects: Record<string, Project[]> = {
	...
	"AI/Machine Learning": [
		...
		},
		{
			title: "Mijikai News",
			description:
				"Mijikai news is a multilingual agent that leverages GPT-4 to provide a summary of news articles and a sentiment analysis of the content",
			image: "/projects/mle/mijikainews.png",
			codeUrl:
				"https://github.com/alpharomercoma/AI-Republic-Bootcamp/tree/master/day_3/ai-first-day-3-activity-4",
			demoUrl: "https://mijikainews.streamlit.app/",
		},
		{
			title: "VerseForge",
			description:
				"An innovative AI-powered music mix and composition platform to generate music based on user preferences",
			image: "/projects/mle/verseforge.png",
			codeUrl:
				"https://github.com/alpharomercoma/AI-Republic-Bootcamp/tree/master/day_3/ai-first-day-3-activity-5-6",
			demoUrl: "https://verseforge.streamlit.app",
		},
		{
			title: "Programming Q&A with fine-tuned Gemma",
			description:
				"An optimized and fine-tuned gemma 2b model specialized in answering programming-related questions in Java and PHP",
			image: "/projects/mle/gemma.png",
			codeUrl:
				"https://github.com/alpharomercoma/AI-Republic-Bootcamp/blob/master/day_2/3-Finetuning-Gemma-2b.ipynb",
			demoUrl:
	...
	Leadership: [
		{
			title: "ACM x GCP",
			description:
				"Double handedly secured a ₱10.2 million deal with Google Cloud Platform for upskilling of 500 members for 12 months at FEU Tech ACM",
			image: "/projects/pm/acm-gcp.png",
			projectUrl:
				"https://cloud.google.com/consulting/portfolio/google-cloud-skills-boost-for-organizations",
		},
		{
			title: "NASA Collaboration",
			description:
				"Coordinated 70 members to receive official limited edition NASA certificates by completing the Open Science curriculum",
			image: "/projects/pm/nasa.jpg",
			projectUrl:
				"https://www.linkedin.com/posts/alpharomercoma_nasa-tops-openscience-activity-7259239998749573120-AqbM",
		},
		{
	...
	Research: [
		{
			title:
				"Augmenting Multimodal Deep Learning with Attention Layers for Recognizing Addictive Neurodegenerative Content",
			description:
